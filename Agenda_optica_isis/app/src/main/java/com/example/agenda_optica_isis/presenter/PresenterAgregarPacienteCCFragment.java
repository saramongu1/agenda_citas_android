...
import com.example.agenda_optica_isis.view.CrearPacienteCCFragment;

public class PresenterAgregarPacienteCCFragment {

    private CrearPacienteCCFragment view;
    private SistemaReservas sistemaReservas;

    public PresenterAgregarPacienteCCFragment(CrearPacienteCCFragment view) {
        this.view = view;
